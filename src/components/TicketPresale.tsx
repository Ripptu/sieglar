      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="relative h-[500px] w-full flex items-center justify-center lg:justify-end">
            ...
            >
              <div className="relative w-full aspect-[1/2] sm:aspect-[2/3] bg-[#b91c1c] p-1 rounded-2xl shadow-[0_30px_60px_rgba(0,0,0,0.8),0_0_40px_rgba(212,175,55,0.2)] overflow-hidden">
